  ...
  const blogs = [
    {
      ...
      description: 'High-quality images enhance brand presence and credibility.',
      image: blogImage1,
    },
    {
      id: 2,
      title: 'Website & App Development',
      description: 'A well-developed platform improves user experience and customer retention.',
      image: blogImage2,
    },
    {
      id: 3,
      title: 'Creative Designing Services',
      description: 'Strong visuals make brands stand out and boost recognition.',
      image: blogImage3,
    },
    {
      id: 4,
      title: 'Digital Marketing Solutions',
      description: 'SEO and social media marketing increase brand awareness and sales.',
      image: blogImage4,
    },
    {
      id: 5,
      title: 'Content Creation & Branding',
      description: 'Engaging content builds trust and strengthens brand identity.',
      image: blogImage5,
    },
  ];
        ...
        {blogs.map((blog) => (
          <SwiperSlide key={blog.id}>
            <div className="blog-card card">
              <Image src={blog.image} className="blog-card-img" alt={blog.title} />
